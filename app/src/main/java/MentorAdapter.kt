...
import com.Muhaimen.i210888.MainActivity11
import com.Muhaimen.i210888.Mentor
...
class MentorAdapter(private var list: ArrayList<Mentor>, private var context: Context): RecyclerView.Adapter<MentorAdapter.MentorViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MentorViewHolder {
        val view: View = LayoutInflater.from(context).inflate(R.layout.activity_mentorcard, parent, false)
    ...
    override fun onBindViewHolder(holder: MentorViewHolder, position: Int) {
        ...
        if (mentor.availability == "Unavailable") {
            holder.availability.setCompoundDrawablesWithIntrinsicBounds(R.drawable.dot2, 0, 0, 0)
        } else {
            holder.availability.setCompoundDrawablesWithIntrinsicBounds(R.drawable.dot2, 0, 0, 0)
        }
        ...
        holder.mentorRow.setOnClickListener {
            val intent = Intent(context, MainActivity11::class.java).apply {
        ...
        holder.fav.setOnClickListener {
            ...
            if (holder.fav.tag == "empty") {
                holder.fav.setImageResource(R.mipmap.heart3)
                holder.fav.tag = "filled"
            } else {
                holder.fav.setImageResource(R.mipmap.heart2)
